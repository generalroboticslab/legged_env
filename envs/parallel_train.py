...
class Launcher:
    ...
    def __init__(self,**kargs) -> None:
        ...
        self.max_parallel = kargs.get("max_parallel",self.num_gpus*self.experiments_per_gpu)
            ...
            while self.can_squeeze_another_process() and next_experiment is not None:
                ...
                if self.stdout is None:
                    ...
                    with os.fdopen(os.open(log_path, os.O_WRONLY | os.O_CREAT | os.O_NONBLOCK), 'w') as log_file:
                        process = subprocess.Popen(cmd_tokens, stdout=log_file, stderr=subprocess.STDOUT,env=envvars)
                ...
                print(f"process started \"{process.proc_cmd}\" GPU {process.gpu_id}")
...
if __name__=="__main__":
    ...
    launcher = Launcher(max_parallel=4,num_gpus=1,experiments_per_gpu=2,train_dir="./output/tmp", pause_between=0,stdout="log.txt")
